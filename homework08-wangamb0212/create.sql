...
copy noc_region FROM '/private/tmp/noc_regions.csv' csv header delimiter as ',' null AS 'NA';
...
copy athlete_event (id, name, sex, age, height, weight, team, noc, games, year, season, city, sport, event, medal) FROM '/private/tmp/athlete_events.csv' csv header delimiter as ',' null AS 'NA';